  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-gray-500 text-center">
        Davam etdiyiniz zaman Şikayətvar-ın{' '}
        <a href="/privacy" className="text-blue-600 hover:text-blue-800">məxfilik siyasəti</a>
        {' '}və{' '}
        <a href="/terms" className="text-blue-600 hover:text-blue-800">istifadə şərtləri</a>
